...
# Login
driver.get('http://192.168.0.220/sws.login/gnb/loginView.sws?basedURL=undefined&popupid=id_Login') 
...
'''
#userSite = 'http://192.168.0.220/sws.application/userManagement/accountingQuotaView.sws'
userSite = 'http://192.168.0.220/sws.application/userProfile/userProfileView.sws'
...
for i in rdr:
    ...
    UsePrintSite = 'http://192.168.0.220/sws.application/userManagement/editAccountID.sws?userid={}&popupid=editAccountID'.format(i['AcountID'])
